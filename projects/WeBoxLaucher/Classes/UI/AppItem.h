...
public:
	...
	bool getIsUninstalledFlag();
	 void setForegroundImage(std::string forgroundImageFilePath,Size contentSize=ITEM_SIZE_APP);
	 void setBackgroundImage(std::string backgroundImageFilePath,Size contentSize=ITEM_SIZE_APP);
