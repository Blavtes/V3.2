...
void FocusHelper::bindItemPanel(ItemPanel* itemPanel)
{
	...
	void FocusHelper::onKeyPressed(EventKeyboard::KeypadEventCode keyCode, EventKeyboard::KeypadEventType eventType, Event* event)
	{
		//....
		 log("Key with keycode %d pressed ", keyCode);
		 switch(keyCode)
		 {
		 case EventKeyboard::KeypadEventCode::kCodeEnter:
			 m_pressedCount +=1;
			 ...
			 break;
		 case EventKeyboard::KeypadEventCode::kCodeRight:
			 this->moveFocusIndicatorToRight();
			 break;
		 case EventKeyboard::KeypadEventCode::kCodeLeft:
			 this->moveFocusIndicatorToLeft();
			 break;
			 case EventKeyboard::KeypadEventCode::kCodeDown:
			 this->moveFocusIndicatorToDown();
			 break;
			 case EventKeyboard::KeypadEventCode::kCodeUp:
	...
	void FocusHelper::onKeyReleased(EventKeyboard::KeypadEventCode keyCode, EventKeyboard::KeypadEventType eventType, Event* event)
	{
