...
//    m_focusHelper->retain();//very important, otherwise , it is autoreleased in the first frame refresh.
   ...
   listener->onKeyPressed = CC_CALLBACK_3(HelloWorld::onKeyPressed,this);
   listener->onKeyReleased = CC_CALLBACK_3(HelloWorld::onKeyReleased, this);
//
...
// 键位响应函数原型
void HelloWorld::onKeyPressed(EventKeyboard::KeypadEventCode keyCode, EventKeyboard::KeypadEventType eventType, Event* event)
{
...
void HelloWorld::onKeyReleased(EventKeyboard::KeypadEventCode keyCode, EventKeyboard::KeypadEventType eventType, Event* event)
{
