...
import com.togic.launcher.util.image.util.ShellUtils.CommandResult;
...
public class PackageUtils {
     ...
     * @return
     */
    public static final int uninstall(Context context, String packageName, boolean isKeepData) {
        Log.v(TAG, "####### uninstall");
        if (PackageUtils.isSystemApplication(context) || ShellUtils.checkRootPermission()) {
